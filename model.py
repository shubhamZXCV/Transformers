...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def attention(query , key , value , mask , dropout : nn.Dropout):
        ...
        # returning attention_scores also for visualisation
    ...
    def forward(self , q , k , v  ,mask):
        ...
        # (batch_size , seq_len , d_model) -> (batch_size , seq_len , h , d_k) -> (batch_size , h , seq_len , d_model)
...
class Encoder(nn.Module):
    def __init__(self  , features : int , layers : nn.ModuleList)->None:
        super().__init__()
        self.layers = layers
        self.norms = LayerNormalisation(features)
...
class Transformer(nn.Module):
    ...
    def __init__(self , encoder : Encoder , decoder : Decoder , src_embed : InputEmbedding , tgt_embed : InputEmbedding , src_pos : PositonalEncoding , tgt_pos : PositonalEncoding , projection_layer: ProjectionLayer)->None:
        super().__init__()
...
def build_transformer(src_vocab_size : int , tgt_vocab_size : int , src_seq_len : int , tgt_seq_len : int ,d_model : int = 512 ,N :int=6, h:int=8  , dropout : float = 0.1 ,  d_ff : int = 2048)->Transformer:
    ...
    # create the positonal embedding layers
    src_pos = PositonalEncoding(d_model , src_seq_len , dropout  )
    tgt_pos = PositonalEncoding(d_model  , tgt_seq_len , dropout)
